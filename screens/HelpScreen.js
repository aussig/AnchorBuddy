      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.scrollContainer}>
          ...
          <View style={styles.introTextContainer}>
            ...
            <Text style={styles.introText}>When anchoring, it's normal not to anchor at the exact depth you were planning, due to seabed irregularities, nearby anchored boats or other factors.  Once you have anchored, you can check the scope you need for the depth you are actually anchored in.  To do this, flick the <Text style={{fontStyle: 'italic'}}>Specify actual anchored depth</Text> toggle on and then enter your depth in the <Text style={{fontStyle: 'italic'}}>Actual depth</Text> field.  AnchorBuddy will then update the scope.</Text>
          </View>
          <View style={styles.introTextContainer}>
